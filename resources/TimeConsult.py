...
class TimeConsult:
    def __init__(self) -> None:
        ...
        self.updated_competence_start = f'01/{self.updated_month}/{self.updated_year}'
        self.updated_competence_end = f'{datetime.now().day}/{self.updated_month}/{self.updated_year}'
